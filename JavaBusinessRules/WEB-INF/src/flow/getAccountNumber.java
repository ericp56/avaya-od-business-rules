 ...
 * Last generated by Orchestration Designer at: 2018-MAY-15  03:49:50 PM
 */
public class getAccountNumber extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("EnterAcctNum", ""));

		// build the list of grammar information objects for the field
		String ___tempGrammarName = null;
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("digits", "1.0"));


		// build events for the field: "getAccountNumber"
		...
		int nbest = 1;
		field = new com.avaya.sce.runtime.Field("getAccountNumber", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("mockAccountRetrieval");
		return submit;
	}
	/**
