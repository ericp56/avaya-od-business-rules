...
public interface IProjectVariables {
	...
	public static final String SALES_MENU = "salesMenu";
	...
	public static final String TRANSFER_SKILL = "transferSkill";
	...
	public static final String ACCOUNT_FIELD_ACCOUNT__NUMBER = "account_number";
	public static final String ACCOUNT_FIELD_BALANCE = "balance";
	public static final String ACCOUNT_FIELD_PHONE_1 = "phone1";
	public static final String ACCOUNT_FIELD_STATUS = "status";
	public static final String ACCOUNT_FIELD_ZIP = "zip";
	public static final String SALES_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String SALES_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String SALES_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String SALES_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SALES_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SALES_MENU_FIELD_UTTERANCE = "utterance";
	public static final String SALES_MENU_FIELD_VALUE = "value";
	public static final String GET_ACCOUNT_NUMBER_FIELD_CONFIDENCE = "confidence";
	public static final String GET_ACCOUNT_NUMBER_FIELD_INPUTMODE = "inputmode";
	public static final String GET_ACCOUNT_NUMBER_FIELD_INTERPRETATION = "interpretation";
	public static final String GET_ACCOUNT_NUMBER_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String GET_ACCOUNT_NUMBER_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String GET_ACCOUNT_NUMBER_FIELD_UTTERANCE = "utterance";
	public static final String GET_ACCOUNT_NUMBER_FIELD_VALUE = "value";
	public static final String ACTIONS_FIELD_BILLING = "BILLING";
	public static final String ACTIONS_FIELD_GENERAL = "GENERAL";
	public static final String ACTIONS_FIELD_MAIN__MENU = "MAIN_MENU";
	public static final String ACTIONS_FIELD_SALES = "SALES";
